...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 =>
          array (
            '_route' => 'generated::SNulOoW44rQBbFFd',
          ),
          1 => NULL,
          2 =>
          array (
      ...
      array (
        ...
        array (
          0 =>
          array (
            '_route' => 'generated::5lwTq4WKxFCR1i40',
          ),
          1 => NULL,
          2 =>
          array (
      ...
      array (
        ...
        array (
          0 =>
          array (
            '_route' => 'generated::7n5tR8F3j1zquD7I',
          ),
          1 => NULL,
          2 =>
          array (
      ...
      array (
        ...
        array (
          0 =>
          array (
            '_route' => 'generated::1naSrlxuvsOiKgRd',
          ),
          1 => NULL,
          2 =>
          array (
    ...
    2 =>
    array (
      0 => '{^(?|/request\\-docs/_astro/(.*js|.*css|.*png|.*jpg|.*jpeg|.*gif|.*svg|.*ico|.*woff|.*woff2|.*ttf|.*eot|.*otf|.*map)(*:117)|/api/v1/tasks/([^/]++)(?|(*:150)|/complete(*:167)))/?$}sDu',
    ),
    3 =>
    array (
      117 =>
      ...
      array (
        ...
        array (
          0 =>
          array (
            '_route' => 'generated::2l9ZfYzPPhqQJGcC',
          ),
          1 =>
          array (
            0 => 'task',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'tasks.index',
        'uses' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@index',
        'controller' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@index',
        'namespace' => NULL,
        'prefix' => 'api/v1',
        'where' =>
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'tasks.store',
        'uses' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@store',
        'controller' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@store',
        'namespace' => NULL,
        'prefix' => 'api/v1',
        'where' =>
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'tasks.show',
        'uses' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@show',
        'controller' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@show',
        'namespace' => NULL,
        'prefix' => 'api/v1',
        'where' =>
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'tasks.update',
        'uses' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@update',
        'controller' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@update',
        'namespace' => NULL,
        'prefix' => 'api/v1',
        'where' =>
        array (
    ...
    array (
      ...
      array (
        ...
        'as' => 'tasks.destroy',
        'uses' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@destroy',
        'controller' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@destroy',
        'namespace' => NULL,
        'prefix' => 'api/v1',
        'where' =>
        array (
    ...
    'generated::2l9ZfYzPPhqQJGcC' =>
    array (
      'methods' =>
      array (
        0 => 'PATCH',
      ),
      'uri' => 'api/v1/tasks/{task}/complete',
      'action' =>
      array (
        'middleware' =>
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@complete',
        'controller' => 'App\\Http\\Controllers\\Api\\V1\\TaskController@complete',
        'namespace' => NULL,
        'prefix' => 'api/v1',
        'where' =>
        array (
        ),
        'as' => 'generated::2l9ZfYzPPhqQJGcC',
      ),
      'fallback' => false,
      'defaults' =>
      array (
